 ...
 *
 ******************************************************************************/
import com.webbertech.algorithm.graph.*;
...
public class Brute {
    ...
    ***************************************************************************/
    ...
    public static int search1(String pat, String txt) {
        ...
        //for last m to n element, it is wasteful to check them
        for (int i = 0; i <= N - M; i++) {
            int j;
            for (j = 0; j < M; j++) {
            	
            	//if the txt does not match pat, then increase the
            	//index of the text
                if (txt.charAt(i+j) != pat.charAt(j))
                    break;
            }
            //don't use counter, 
            //if j CAN scan to the end of pat, then it is a match!
            if (j == M) 
