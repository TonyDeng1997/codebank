...
1/ IPv4 addresses are canonically represented in dot-decimal notation, 
...
2/ IPv6 addresses are represented as eight groups of four hexadecimal digits, 
 ...
 * */
public class ValidateIPAddress_leetcode468 {
...
public String validIPAddress(String IP) {
	...
	//solution1 using parsing, generic way
	...
	//solution2 using regex
	  public String validIPAddressII(String IP) {
		  
		    // need to understand the ipv4. 
		    /*  [0-9] ,meaning 1.1.1.1, single digit
		     *  [1-9][0-9] is two digits like 22.22.20.29
		     *  1[0-9][0-9] is three digits like 101.199.100.199
		     *  2[0-4][0-9] is three digits like 249.209.0.1
		     *  25[0-5] is special three digits like 255.255.0.1 
		     * 
		     *  Because the four groups are identical, the only difference is \\. comes
		     *  with first group and it can repeat 3 times.
		     * */
	        if(IP.matches("(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}"
	        		+ "     ([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])")) {
	        	     return "IPv4";
	        }
	        
	        /*
	         * ipv6: 32 bit, eight group, each group is 16 digits(hex), seperated by : not ::, each group is 1 to 4.
	         * each group requirement is identical.
...
public static void main(String[] args) {
	//System.out.println(isIPV4("172.16.254.1"));
	//System.out.println(isIPV4("172.16.254.01"));
}
