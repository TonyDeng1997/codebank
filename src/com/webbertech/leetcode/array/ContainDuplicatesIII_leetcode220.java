 ...
 * is at most t and the absolute difference between i and j 
 * is at most k. 
 * */
public class ContainDuplicatesIII_leetcode220 {

	
	/*For example, 1,6,4,5,1,1, t = 2, k=2
	 * 
	 * for distance<= 2, (6,4), will be at most at k=2, (4,5) and (1,1) 
	 * */
	
	/*
	 * Solution 1: 
	 * 1/ build a map with key: number, value: index
	 * 2/ loop the number from the array and try to see that if the distance is at k.
	 * It works if there is no dup otherwise how to build a map with dup?
	 * 
	 * 
	 * 
	 * 
...
* */
	...
	public static void main(String[] args) {
		...
		t=1;
		k=1;
		System.out.println(containsNearbyAlmostDuplicate(b, k, t));
	}
}
